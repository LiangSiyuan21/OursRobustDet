...
def add_args():
    ...
    parser.add_argument('--cfg', default='cfgs/MTD_coco.yaml')
    parser.add_argument('--adv_type', default='mtd')
    parser.add_argument('--data_use', default='clean')
    parser.add_argument('--multi_gpu', default=False)
    parser.add_argument('--dataset_root', default='/public/data/dataset/coco')
...
def train():
    ...
    if args.cuda:
        print(torch.Generator(device='cuda'))
        data_loader = data.DataLoader(dataset, args.batch_size//2,
                                    num_workers=args.num_workers,
                                    shuffle=True, collate_fn=detection_collate,
                                    pin_memory=True, drop_last=True, 
